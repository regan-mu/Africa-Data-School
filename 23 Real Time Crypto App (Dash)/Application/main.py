...
app.description = "This is a class project for the ADS April 2022 Data Science cohort"
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                html.H1("Africa Data School", style={'margin-bottom': '0px', 'color': 'pink', 'text-align': 'center'}),
                html.H5("CryptoCurrency Prices", style={'margin-bottom': '0px', 'color': 'pink', 'text-align': 'center'})
            ])
    ...
    html.Div([
        ...
        html.Div([
            html.Label('Crypto Asset', style={'color': '#FF00BD', 'margin-bottom': '5px'}),
            dcc.Dropdown(
                id='coin',
                options=[
        ...
        html.Div([
            html.Label('Time', style={'color': '#FF00BD', 'margin-bottom': '5px'}),
            dcc.Dropdown(
                id='time',
                options=[
